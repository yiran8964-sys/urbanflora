import{n,Y as g,t as r,p as d,O as p,s as M}from"./property-CWX-Azq2.js";var u=Object.defineProperty,w=Object.getOwnPropertyDescriptor,s=(a,o,h,i)=>{for(var e=i>1?void 0:i?w(o,h):o,l=a.length-1,c;l>=0;l--)(c=a[l])&&(e=(i?c(o,h,e):c(e))||e);return i&&e&&u(o,h,e),e};let t=class extends n{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;s([p({type:String,reflect:!0})],t.prototype,"size",2);s([p({type:String,reflect:!0})],t.prototype,"weight",2);s([p({type:String,reflect:!0})],t.prototype,"color",2);s([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=s([M("ph-user")],t);export{t as PhUser};
