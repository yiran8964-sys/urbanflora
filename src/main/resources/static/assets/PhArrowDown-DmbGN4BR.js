import{n as g,Y as d,t as r,p as w,O as s,s as c}from"./property-CWX-Azq2.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,h,i)=>{for(var e=i>1?void 0:i?y(l,h):l,p=a.length-1,n;p>=0;p--)(n=a[p])&&(e=(i?n(l,h,e):n(e))||e);return i&&e&&u(l,h,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-arrow-down")],t);export{t as PhArrowDown};
