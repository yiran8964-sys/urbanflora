import{n as L,Y as g,t as r,p as d,O as p,s as c}from"./property-CWX-Azq2.js";var u=Object.defineProperty,w=Object.getOwnPropertyDescriptor,o=(a,i,s,l)=>{for(var e=l>1?void 0:l?w(i,s):i,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(l?n(i,s,e):n(e))||e);return l&&e&&u(i,s,e),e};let t=class extends L{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([p({type:String,reflect:!0})],t.prototype,"size",2);o([p({type:String,reflect:!0})],t.prototype,"weight",2);o([p({type:String,reflect:!0})],t.prototype,"color",2);o([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-x")],t);export{t as PhX};
