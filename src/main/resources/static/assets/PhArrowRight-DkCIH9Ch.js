import{n,Y as d,t as r,p as c,O as s,s as w}from"./property-CWX-Azq2.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,a=(o,i,h,l)=>{for(var e=l>1?void 0:l?y(i,h):i,p=o.length-1,g;p>=0;p--)(g=o[p])&&(e=(l?g(i,h,e):g(e))||e);return l&&e&&u(i,h,e),e};let t=class extends n{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return d`<svg
  ...
  `;a([s({type:String,reflect:!0})],t.prototype,"size",2);a([s({type:String,reflect:!0})],t.prototype,"weight",2);a([s({type:String,reflect:!0})],t.prototype,"color",2);a([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=a([w("ph-arrow-right")],t);export{t as PhArrowRight};
