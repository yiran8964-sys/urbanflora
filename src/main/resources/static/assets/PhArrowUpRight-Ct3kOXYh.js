import{n as g,Y as d,t as r,p as c,O as p,s as w}from"./property-CWX-Azq2.js";var u=Object.defineProperty,L=Object.getOwnPropertyDescriptor,a=(o,s,h,i)=>{for(var e=i>1?void 0:i?L(s,h):s,l=o.length-1,n;l>=0;l--)(n=o[l])&&(e=(i?n(s,h,e):n(e))||e);return i&&e&&u(s,h,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return d`<svg
  ...
  `;a([p({type:String,reflect:!0})],t.prototype,"size",2);a([p({type:String,reflect:!0})],t.prototype,"weight",2);a([p({type:String,reflect:!0})],t.prototype,"color",2);a([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=a([w("ph-arrow-up-right")],t);export{t as PhArrowUpRight};
