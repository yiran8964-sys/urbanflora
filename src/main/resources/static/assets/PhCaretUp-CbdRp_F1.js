import{n as g,Y as d,t as r,p as c,O as i,s as u}from"./property-CWX-Azq2.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,p,s)=>{for(var e=s>1?void 0:s?y(l,p):l,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(s?n(l,p,e):n(e))||e);return s&&e&&w(l,p,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([u("ph-caret-up")],t);export{t as PhCaretUp};
