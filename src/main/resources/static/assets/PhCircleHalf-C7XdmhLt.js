import{n,Y as g,t as r,p as c,O as s,s as V}from"./property-CWX-Azq2.js";var m=Object.defineProperty,d=Object.getOwnPropertyDescriptor,o=(a,i,l,p)=>{for(var e=p>1?void 0:p?d(i,l):i,h=a.length-1,Z;h>=0;h--)(Z=a[h])&&(e=(p?Z(i,l,e):Z(e))||e);return p&&e&&m(i,l,e),e};let t=class extends n{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([V("ph-circle-half")],t);export{t as PhCircleHalf};
