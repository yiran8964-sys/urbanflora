import{n as g,Y as d,t as r,p as c,O as s,s as w}from"./property-CWX-Azq2.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(l,a,p,i)=>{for(var e=i>1?void 0:i?y(a,p):a,h=l.length-1,n;h>=0;h--)(n=l[h])&&(e=(i?n(a,p,e):n(e))||e);return i&&e&&u(a,p,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var l;return d`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([w("ph-caret-down")],t);export{t as PhCaretDown};
