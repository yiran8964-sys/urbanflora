import{n as g,Y as d,t as r,p as c,O as p,s as w}from"./property-CWX-Azq2.js";var u=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,s,i)=>{for(var e=i>1?void 0:i?y(l,s):l,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(i?n(l,s,e):n(e))||e);return i&&e&&u(l,s,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;o([p({type:String,reflect:!0})],t.prototype,"size",2);o([p({type:String,reflect:!0})],t.prototype,"weight",2);o([p({type:String,reflect:!0})],t.prototype,"color",2);o([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([w("ph-arrow-up")],t);export{t as PhArrowUp};
