import{n as m,Y as Z,t as r,p as g,O as s,s as c}from"./property-CWX-Azq2.js";var A=Object.defineProperty,d=Object.getOwnPropertyDescriptor,o=(a,i,h,p)=>{for(var e=p>1?void 0:p?d(i,h):i,l=a.length-1,n;l>=0;l--)(n=a[l])&&(e=(p?n(i,h,e):n(e))||e);return p&&e&&A(i,h,e),e};let t=class extends m{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return Z`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-warning-circle")],t);export{t as PhWarningCircle};
