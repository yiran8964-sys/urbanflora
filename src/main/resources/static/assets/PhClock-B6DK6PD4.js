import{n as g,Y as c,t as r,p as Z,O as p,s as d}from"./property-CWX-Azq2.js";var m=Object.defineProperty,A=Object.getOwnPropertyDescriptor,o=(a,h,s,i)=>{for(var e=i>1?void 0:i?A(h,s):h,l=a.length-1,n;l>=0;l--)(n=a[l])&&(e=(i?n(h,s,e):n(e))||e);return i&&e&&m(h,s,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([p({type:String,reflect:!0})],t.prototype,"size",2);o([p({type:String,reflect:!0})],t.prototype,"weight",2);o([p({type:String,reflect:!0})],t.prototype,"color",2);o([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-clock")],t);export{t as PhClock};
